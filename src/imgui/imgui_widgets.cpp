...
bool ImGui::ColorButton(const char* desc_id, const ImVec4& col, ImGuiColorEditFlags flags, ImVec2 size)
{
    ...
    if ((flags & ImGuiColorEditFlags_NoBorder) == 0)
    {
        ...
        #ifdef __APPLE__
           window->DrawList->AddRect(bb.Min - ImVec2(3, 3), bb.Max + ImVec2(3, 3), GetColorU32(ImGuiCol_FrameBg), rounding * 2, ImDrawFlags_None, 4.0f);; // Color button are often in need of some sort of border
        #else
            window->DrawList->AddRect(bb.Min - ImVec2(2, 2), bb.Max + ImVec2(2, 2), GetColorU32(ImGuiCol_FrameBg), rounding * 2, ImDrawFlags_None, 3.0f); // Color button are often in need of some sort of border
        #endif
    }
